...
用法:
  python -m noteforge.batch.bilibili urls.txt              # 处理列表
  python -m noteforge.batch.bilibili urls.txt --resume     # 断点续传
  python -m noteforge.batch.bilibili urls.txt --dry-run    # 预览
  python -m noteforge.batch.bilibili urls.txt --force      # 强制重新处理
...
ENGINE_CMD = [str(PYTHON_EXE), '-m', 'noteforge']  # 替代 scripts/cli.py
