...
class TestCreateProvider:
    ...
    def test_claude_provider_creation(self):
        ...
        from llm_providers import create_provider, ClaudeProvider
    ...
    def test_openai_provider_creation(self):
        ...
        from llm_providers import create_provider, OpenAIProvider
    ...
    def test_local_provider_creation(self):
        ...
        from llm_providers import create_provider, LocalProvider
...
class TestProviderConfig:
    ...
    def test_local_context_limit(self):
        ...
        from llm_providers import LocalProvider
    ...
    def test_claude_missing_api_key_raises(self):
        ...
        from llm_providers import ClaudeProvider, LLMError
    ...
    def test_openai_missing_api_key_raises(self):
        ...
        from llm_providers import OpenAIProvider, LLMError
    ...
    def test_default_model_names(self):
        """未指定 model 时应使用默认模型名"""
        from llm_providers import ClaudeProvider, OpenAIProvider, LocalProvider
